...
const Contact = () => {
    ...
    return (<div className="w-full" id="contact">
        <h1 className="w-full text-center font-bold text-gray-600 mt-10 dark:text-white">Hire me!</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-5 lg:mt-10">
            ...
            <div className="mt-5">
                <label className="text-blue-500 font-medium text-sm mb-2 dark:text-gray-300">Your email:</label>
            ...
            <div className="mt-5">
                <label className="text-blue-500 font-medium text-sm mb-2 dark:text-gray-300">Your message:</label>
