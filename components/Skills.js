...
const Skills = () => {
  return (<div className="w-full mx-auto">
    ...
    <div className="w-3/5 h-3 hidden lg:flex rounded-full bg-pink-500 mx-auto mt-10 shadow-lg justify-between">
    ...
    <div className="flex w-full justify-around flex-col lg:flex-row">
      ...
      <div className="mt-5 lg:mt-10 w-full mx-auto flex flex-col flex-wrap justify-between ">
