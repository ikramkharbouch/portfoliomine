...
const Brief = () => {
  ...
  const DevUrl = "https://dev.to/ikramkharbouch"
    ...
    return (
    <div className="h-96  rounded border-2 mx-auto mt-10 border-blue-300 w-full">
        <div className="w-4/6 mx-auto">
            <h1 className="mt-11 text-gray-600 font-bold text-lg">Welcome to my portfolio</h1>
            <p className="text-sm lg:text-base mt-7 font-light">I am a 1337 student. A web developer who is looking to grow through new experiences.</p>
        </div>
        <div className="flex mx-auto flex-col lg:flex-row text-center w-4/6 mt-10 gap-5 items-center">
