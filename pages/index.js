          ...
          <div className="grid grid-cols-2 mx-auto gap-4 mt-10 w-full">
            <div className="h-40 border-2 border-blue-300 rounded-lg">
              ...
              <div className="mt-5 mx-5 flex gap-2">
                {/* tags in here */}
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-20 rounded-full py-1">PHP</div>
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-24 rounded-full py-1">Javascript</div>
              </div>
            </div>
            <div className="h-40 border-2 border-blue-300 rounded-lg">
              <div className="flex justify-between mx-5 m-4">
              ...
              <div className="mt-5 mx-5 flex gap-2">
                {/* tags in here */}
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-20 rounded-full py-1">React</div>
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-24 rounded-full py-1">ExpressJs</div>
              </div>
            </div>
            <div className="h-40 border-2 border-blue-300 rounded-lg"><div className="flex justify-between mx-5 m-4">
              ...
              <div className="mt-5 mx-5 flex gap-2">
                {/* tags in here */}
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-20 rounded-full py-1">NextJs</div>
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-24 rounded-full py-1">Postgresql</div>
              </div></div>
            <div className="h-40 border-2 border-blue-300 rounded-lg"><div className="flex justify-between mx-5 m-4">
              ...
              <div className="mt-5 mx-5 flex gap-2">
                {/* tags in here */}
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-20 rounded-full py-1">React</div>
                <div className="text-xs font-bold text-indigo-500 bg-blue-100 w-24 rounded-full py-1">Docker</div>
              </div></div>
          </div>
          <Shape />
          <h1 className="text-gray-600 font-bold text-lg mt-10">Talks</h1>
          <div className="w-full mt-10 mx-auto">
            <ReactPlayer url='https://www.youtube.com/watch?v=4CccgPH8yck' width="300px" height="300px"/>
          </div>
        </div>
      </div>
